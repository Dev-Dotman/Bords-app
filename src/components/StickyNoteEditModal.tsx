    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-[9999] flex items-center justify-center">
      ...
      >
        ...
        <textarea
          ...
          className="w-full h-40 p-4 border-0 rounded-2xl resize-none focus:ring-2 focus:ring-blue-400/50 focus:outline-none bg-white/90 backdrop-blur-sm shadow-sm text-gray-900 placeholder:text-gray-500"
